...
public class CourseTeacherService {
    ...
    public List<CourseTeacherInfo> findCourseTeacherInfo(Map<String, String> map) {
        ...
        System.out.println(courseTeacherMapper.findCourseTeacherInfo(tno, tname, tFuzzy, cid, cname, cFuzzy));
        return courseTeacherMapper.findCourseTeacherInfo(tno, tname, tFuzzy, cid, cname, cFuzzy);
    }
