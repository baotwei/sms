...
public class SCTcontroller {
    ...
    @GetMapping("/findById/{sno}/{cid}/{tid}/{term}")
    public SCTInfo findById(@PathVariable Integer sno,
                            @PathVariable Integer cid,
                            @PathVariable Integer tno,
                            @PathVariable String term) {
        return sctService.findByIdWithTerm(sno, cid, tno, term);
    }
